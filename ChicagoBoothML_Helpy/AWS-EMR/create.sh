...
AWS_EMR_BOOTACT_LAUNCH_IPYTHON_SCRIPT_NAME=AWS-EMR-BootAct-LaunchIPython.sh
...
aws s3 cp \
    ...
    --no-verify-ssl
aws s3 cp \
    BootActs/$AWS_EMR_BOOTACT_LAUNCH_IPYTHON_SCRIPT_NAME \
    s3://$S3_BUCKET_NAME/$AWS_EMR_BOOTACT_LAUNCH_IPYTHON_SCRIPT_NAME \
    --region us-west-1 \
    --no-verify-ssl
aws s3 cp \
...
aws emr create-cluster \
    ...
    --bootstrap-actions \
        ...
        Path=s3://$S3_BUCKET_NAME/$AWS_EMR_BOOTACT_LAUNCH_IPYTHON_SCRIPT_NAME,Name=$AWS_EMR_BOOTACT_LAUNCH_IPYTHON_SCRIPT_NAME \
    --steps \
