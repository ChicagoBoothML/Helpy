...
aws emr create-cluster \
    ...
    --steps \
        Type=CUSTOM_JAR,Jar=s3://elasticmapreduce/libs/script-runner/script-runner.jar,Args=[-files,$AWS_EMR_TMPDIR/$AWS_EMR_STEP_LAUNCH_IPYTHON_SCRIPT_NAME],Name=$AWS_EMR_STEP_LAUNCH_IPYTHON_SCRIPT_NAME,ActionOnFailure=CONTINUE \
        Type=CUSTOM_JAR,Jar=s3://elasticmapreduce/libs/script-runner/script-runner.jar,Args=[-files,$AWS_EMR_TMPDIR/$AWS_EMR_STEP_INSTALL_VISUALIZATION_PACKAGES_SCRIPT_NAME],Name=$AWS_EMR_STEP_INSTALL_VISUALIZATION_PACKAGES_SCRIPT_NAME,ActionOnFailure=CONTINUE \
        Type=CUSTOM_JAR,Jar=s3://elasticmapreduce/libs/script-runner/script-runner.jar,Args=[-files,$AWS_EMR_TMPDIR/$AWS_EMR_STEP_INSTALL_SCIKITS_AND_ML_PACKAGES_SCRIPT_NAME],Name=$AWS_EMR_STEP_INSTALL_SCIKITS_AND_ML_PACKAGES_SCRIPT_NAME,ActionOnFailure=CONTINUE \
        Type=CUSTOM_JAR,Jar=s3://elasticmapreduce/libs/script-runner/script-runner.jar,Args=[-files,$AWS_EMR_TMPDIR/$AWS_EMR_STEP_INSTALL_GRAPH_AND_NETWORK_PACKAGES_SCRIPT_NAME],Name=$AWS_EMR_STEP_INSTALL_GRAPH_AND_NETWORK_PACKAGES_SCRIPT_NAME,ActionOnFailure=CONTINUE \
        Type=CUSTOM_JAR,Jar=s3://elasticmapreduce/libs/script-runner/script-runner.jar,Args=[-files,$AWS_EMR_TMPDIR/$AWS_EMR_STEP_INSTALL_GEOSPATIAL_PACKAGES_SCRIPT_NAME],Name=$AWS_EMR_STEP_INSTALL_GEOSPATIAL_PACKAGES_SCRIPT_NAME,ActionOnFailure=CONTINUE \
        Type=CUSTOM_JAR,Jar=s3://elasticmapreduce/libs/script-runner/script-runner.jar,Args=[-files,$AWS_EMR_TMPDIR/$AWS_EMR_STEP_INSTALL_DEEP_LEARNING_PACKAGES_SCRIPT_NAME],Name=$AWS_EMR_STEP_INSTALL_DEEP_LEARNING_PACKAGES_SCRIPT_NAME,ActionOnFailure=CONTINUE
